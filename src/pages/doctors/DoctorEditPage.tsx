...
export const DoctorEditPage: React.FC = () => {
    ...
    const [updateDoctor, { isLoading: isUpdating }] = doctorApi.useUpdateDoctorMutation();
    const { data: doctor, isLoading: isFetching } = doctorApi.useFetchDoctorByIdQuery(Number(id));
